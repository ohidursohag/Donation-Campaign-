         ...
         <div>
            ...
            <form className="px-2">
               <div className="relative max-w-[500px] mx-auto my-10">
                  ...
                  <div>
                     <input type="search" className=" w-full outline-none p-4 pl-10   text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:border-[#FF444A]  " placeholder="Search here..." required />
                     <button type="submit" className="text-white absolute right-0 bottom-0 bg-[#ff444ae9] hover:bg-[#ff272e] font-medium rounded-r-lg md:text-lg  h-full px-4 md:px-8 py-2 ">Search</button>
                  </div>
               </div>
            </form>
